...
CONCERN_KEYWORDS: dict[str, list[tuple[str, str]]] = {
    ...
    "家居用品": [
        ("床品家纺", "四件套|床单|被套|枕头|被子|亲肤|棉"),
        ("厨房烹饪", "锅|刀具|砧板|餐具|不粘|烹饪"),
        ("收纳整理", "收纳|置物|挂钩|衣架|整理|省空间"),
        ("饮水杯壶", "保温杯|水杯|杯|保温|保冷"),
        ("家居装饰", "香薰|花瓶|台灯|落地灯|氛围|装饰"),
    ],
    "母婴用品": [
        ("喂养用品", "奶瓶|奶嘴|吸奶器|温奶器|喂养|防胀气"),
        ("尿裤清洁", "纸尿裤|尿不湿|湿巾|洗衣液|沐浴露|柔软|透气"),
        ("出行安全", "推车|安全座椅|出行|便携|避震"),
        ("早教玩具", "玩具|绘本|积木|早教|益智"),
    ],
    "运动户外": [
        ("露营装备", "帐篷|睡袋|防水|露营|户外|登山杖"),
        ("健身器材", "哑铃|瑜伽垫|跳绳|拉力器|训练|燃脂"),
        ("球类运动", "篮球|足球|球拍|羽毛球|乒乓球|网球"),
        ("游泳骑行", "泳镜|泳衣|游泳|骑行|头盔"),
    ],
    "个护清洁": [
        ("洗发护发", "洗发|护发|去屑|控油|柔顺|蓬松"),
        ("身体清洁", "沐浴|身体乳|洗手液|保湿|滋润"),
        ("口腔护理", "牙膏|牙刷|漱口水|美白|口气"),
        ("衣物家清", "洗衣液|柔顺剂|消毒|除菌|去污"),
        ("美发美体", "吹风机|卷发|直发|剃须|脱毛"),
    ],
}
